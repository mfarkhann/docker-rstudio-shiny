...
RUN  . /etc/environment \
    ...
    Rfacebook XLConnect googledrive googlesheets googleAnalyticsR googleCloudStorageR sparklyr pool bcrypt instaR gtrendsR aws.s3 V8 js openxlsx maptools aws.ec2metadata redshiftTools furrr RPostgreSQL\
    # For Analytics
